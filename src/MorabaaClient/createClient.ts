...
export const createCashedGetFunction = <Response = any>({ url, params, clearCash }: IGet) => {
    return new Promise<Response>(async (resolve, reject) => {
...
export const createPostFunction = <Response = any>({ url, params, clearCash, body }: IPost) => {
    return new Promise<Response>(async (resolve, reject) => {
...
export const createUpdateFunction = <Response = any>({ url, params, clearCash, body }: IPost) => {
    return new Promise<Response>(async (resolve, reject) => {
        const retry = () => createCashedGetFunction({ url, clearCash });
        try {
            const query = generateQuery({ url, params });
...
export const createDeleteFunction = <Response = any>({ url, params, clearCash }: IGet) => {
    return new Promise<Response>(async (resolve, reject) => {
        const retry = () => createCashedGetFunction({ url, clearCash });
        try {
            const query = generateQuery({ url, params });
